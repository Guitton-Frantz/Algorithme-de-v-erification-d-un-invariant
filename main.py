...
state0 = State("0", ["nc1", "nc2", "y=1"])
state1 = State("1", ["p1", "nc2", "y=1"])
state2 = State("2", ["nc1", "p2", "y=1"])
state3 = State("3", ["p1", "p2", "y=1"])
state4 = State("4", ["c1", "nc2", "y=0"])
state5 = State("5", ["nc1", "c2", "y=0"])
state6 = State("6", ["c1", "p2", "y=0"])
state7 = State("7", ["p1", "c2", "y=0"])
